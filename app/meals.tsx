...
export default function Meals() {
  ...
  const filteredMeals = mealSuggestions.filter(
    (meal) => meal.ageGroup === selectedAge
  );
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Age-appropriate recipes for your baby
        </Text>
      </View>
      ...
      <View style={styles.mealsContainer}>
        {filteredMeals.length === 0 ? (
          <Text style={styles.emptyText}>
            No meals found for this age group. Check back soon!
          </Text>
        ) : (
      ...
      <View style={styles.tipCard}>
        ...
        <Text style={styles.tipText}>
          Always supervise your baby during meals and introduce new foods one at
          a time to watch for allergic reactions.
        </Text>
      </View>
    </ScrollView>
  );
