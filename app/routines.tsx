  ...
  const [routines] = useState([
    {
      ...
      time: "7:00 AM",
      tasks: ["Feeding", "Diaper change", "Tummy time"],
      completed: true,
    },
    {
      id: "2",
    ...
    },
    {
      ...
      time: "6:00 PM",
      tasks: ["Bath", "Feeding", "Bedtime story"],
      completed: false,
    },
  ]);
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Stay on track with your baby's schedule
        </Text>
      </View>
