  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.checkCard}>
        ...
        <View style={styles.moodSelector}>
          {moods.map((mood, index) => (
            <TouchableOpacity
              key={index}
              style={[styles.moodButton, moodScore === index && styles.selectedMood]}
      ...
      <View style={styles.checkCard}>
        ...
        <View style={styles.energySelector}>
          {energyLevels.map((energy, index) => (
            <TouchableOpacity
              key={index}
              style={[styles.energyButton, energyLevel === index && styles.selectedEnergy]}
      ...
      <View style={styles.tipsCard}>
        ...
        <Text style={styles.tipItem}>• Stay hydrated and eat nutritious meals</Text>
...
const styles = StyleSheet.create({
  ...
  checkCard: { backgroundColor: 'white', margin: 20, padding: 16, borderRadius: 12, elevation: 2 },
  checkTitle: { fontSize: 18, fontWeight: '600', color: '#1e293b', marginBottom: 16 },
  moodSelector: { flexDirection: 'row', justifyContent: 'space-between' },
  moodButton: { width: 50, height: 50, borderRadius: 25, backgroundColor: '#f1f5f9', alignItems: 'center', justifyContent: 'center' },
  selectedMood: { backgroundColor: '#6366f1' },
  moodEmoji: { fontSize: 24 },
  energySelector: { flexDirection: 'row', justifyContent: 'space-between' },
  energyButton: { flex: 1, paddingVertical: 8, marginHorizontal: 2, borderRadius: 8, backgroundColor: '#f1f5f9', alignItems: 'center' },
  selectedEnergy: { backgroundColor: '#10b981' },
  energyText: { fontSize: 12 },
  tipsCard: { backgroundColor: '#dcfce7', margin: 20, padding: 16, borderRadius: 12 },
  tipsTitle: { fontSize: 16, fontWeight: '600', color: '#166534', marginBottom: 12 },
  tipItem: { fontSize: 14, color: '#166534', marginBottom: 8, lineHeight: 20 },
  saveButton: { backgroundColor: '#6366f1', marginHorizontal: 20, paddingVertical: 16, borderRadius: 12, alignItems: 'center', marginBottom: 40 },
